 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup 
  ...
  #define HSE_STARTUP_TIMEOUT    ((uint32_t)0xFFFF00)   /*!< Time out for HSE start up */
...
/** @addtogroup Peripheral_memory_map
  * @{
  */
#define FLASH_BASE            ((uint32_t)0x08020000) /*!< FLASH(up to 1 MB) base address in the alias region                         */
